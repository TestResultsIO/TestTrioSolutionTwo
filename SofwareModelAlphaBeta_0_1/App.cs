...
using static TestImages.SofwareModelAlphaBeta;

namespace SofwareModelAlphaBeta_Model
{
    public partial class SofwareModelAlphaBetaApp : IWebAppBasics
    {
        ...
        public SofwareModelAlphaBetaApp(ITester t)
        {
            Tester = t;
